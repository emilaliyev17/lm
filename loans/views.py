...
def loan_list(request):
    ...
    loans = LoanCard.objects.select_related('borrower', 'dynamic_status').all()
    ...
    for loan in loans:
        ...
        loan_data.append({
            ...
            'interest_rate_display': format(loan.initial_interest_rate * Decimal('100'), '.2f'),
...
@login_required
@require_POST
def change_loan_status(request, card_number):
